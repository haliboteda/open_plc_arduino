 ...
 *
 * Runs as a KNX TP device (MASK_VERSION 0x07B0) or KNXnet/IP device
 * (MASK_VERSION 0x57B0), selectable at compile time via the board variant.
 * The coupler role (0x091A) does not use application group objects — use a
 * dedicated coupler sketch for that.
 *
