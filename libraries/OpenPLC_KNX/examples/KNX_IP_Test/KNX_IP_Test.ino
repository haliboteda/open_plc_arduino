 ...
 *   KNX Role : KNXnet/IP Device (IP only, MASK 0x57B0)   ← IMPORTANT
 ...
 *
 * ETS PROJECT SETUP
 *   Create a new ETS project.  Add a "Generic" device, set mask version 0x57B0.
...
void setup()
{
    ...
    Serial_Test.println("[KNX] Stack started (MASK 0x57B0 — KNXnet/IP device)");
    if (KNX.configured()) {
