...
{
    print("[DD_READ] asap=0x");
    print(asap, HEX);
    print(" descType=");
    println(descriptorType, HEX);
    ...
    print("[DD_READ] responding mask=0x");
    println(_deviceObj.maskVersion(), HEX);
...
{
    print("[IA_READ] progMode=");
    println(_deviceObj.progMode() ? "Y" : "N");
