...
// Produce print and println for Arduino STM32 by forwarding to KNX_DEBUG_SERIAL.
#if defined(ARDUINO) && defined(ARDUINO_ARCH_STM32) && !defined(KNX_NO_PRINT)
void print(const char str[])               { KNX_DEBUG_SERIAL.print(str); }
void print(char c)                         { KNX_DEBUG_SERIAL.print(c); }
void print(unsigned char b, int base)      { KNX_DEBUG_SERIAL.print(b, base); }
void print(int n, int base)                { KNX_DEBUG_SERIAL.print(n, base); }
void print(unsigned int n, int base)       { KNX_DEBUG_SERIAL.print(n, base); }
void print(long n, int base)               { KNX_DEBUG_SERIAL.print(n, base); }
void print(unsigned long n, int base)      { KNX_DEBUG_SERIAL.print(n, base); }
void print(long long n, int base)          { KNX_DEBUG_SERIAL.print(n, base); }
void print(unsigned long long n, int base) { KNX_DEBUG_SERIAL.print(n, base); }
void print(double n)                       { KNX_DEBUG_SERIAL.print(n); }
void println(void)                         { KNX_DEBUG_SERIAL.println(); }
void println(const char c[])               { KNX_DEBUG_SERIAL.println(c); }
void println(char c)                       { KNX_DEBUG_SERIAL.println(c); }
void println(unsigned char b, int base)    { KNX_DEBUG_SERIAL.println(b, base); }
void println(int num, int base)            { KNX_DEBUG_SERIAL.println(num, base); }
void println(unsigned int num, int base)   { KNX_DEBUG_SERIAL.println(num, base); }
void println(long num, int base)           { KNX_DEBUG_SERIAL.println(num, base); }
void println(unsigned long num, int base)  { KNX_DEBUG_SERIAL.println(num, base); }
void println(long long num, int base)      { KNX_DEBUG_SERIAL.println(num, base); }
void println(unsigned long long num, int base) { KNX_DEBUG_SERIAL.println(num, base); }
void println(double num)                   { KNX_DEBUG_SERIAL.println(num); }
#endif // ARDUINO && ARDUINO_ARCH_STM32 && !KNX_NO_PRINT
