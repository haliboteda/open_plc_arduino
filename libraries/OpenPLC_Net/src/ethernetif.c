...
static volatile uint8_t EthRxEvent = 0U;
...
static void low_level_init(struct netif *netif)
{
  ...
  /* Start ETH HAL Init */
   ...
   MACAddr[5] = MAC_ADDR5;
#else
   openplc_make_mac_from_uid(MACAddr);
#endif
...
void HAL_ETH_MspDeInit(ETH_HandleTypeDef* ethHandle)
{
  ...
  /* USER CODE END ETH_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_12|GPIO_PIN_11);
...
uint8_t ethernetif_rx_event_pending(void)
{
  return EthRxEvent;
}

void ethernetif_rx_event_clear(void)
{
  EthRxEvent = 0U;
}
